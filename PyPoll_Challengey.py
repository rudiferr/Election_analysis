...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        votes_total += 1    # Changed for iteration consistency
...
with open(file_to_save, "w") as txt_file:
    ...
    # Replicated candidatets for loop
    # 6a: Write a for loop to get the county from the county dictionary.
    for county_name in county_votes:
        # 6b: Retrieve the county vote count.
        votes = county_votes.get(county_name)
        # 6c: Calculate the percentage of votes for the county.
        votes_percentage = float(votes) / float(votes_total) * 100
    ...
    county_largest_results = (
        f""
        f"-------------------------\n"
        f"County With The Largest Turnout: {county_largest}\n"
        f"-------------------------\n"
        )
    ...
    winning_count = 0       # Have to zero variable for later usage
